...
public class ForgotPassword extends JFrame implements ActionListener {
    ...
    ForgotPassword(){
        setBounds(300,175,850,380);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
          
        JLabel l11 = new JLabel("FORGOT PASSWORD");
        l11.setBounds(230,0,250,25);
        l11.setFont(new Font("TimesRoman",Font.BOLD,20));
        add(l11);
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("outingassist/icons/forgotpassword.jpg"));
