...
JButton b1,b2;
    ...
    Signup(){
        setBounds(300,170,900,360);    
        getContentPane().setBackground(Color.RED);
        setLayout(null);
         
        JLabel l11 = new JLabel("SIGN UP");
        l11.setBounds(630,0,250,25);
        l11.setFont(new Font("TimesRoman",Font.BOLD,30));
        add(l11);
       ...
       p1.add(t3);
        ...
        c1.add("Fav character form The Boys?");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("outingassist/icons/signup.png"));
