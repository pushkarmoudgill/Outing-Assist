...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"Clarkes Hotel","Asia The Dawn Hotel","Sunrise Hotel","Radisson Hotel","Wild Flower Hotel","Willow Banks  Hotel","Breeze Blows Hotel","Summit Le Royale Hotel","Happy Mornings Motel","The Oberio Cecil Hotel"};
        try{
            for(int i = 0 ; i <= 9 ; i++){
    ...
    CheckHotels(){
        ...
        for(int i =0; i <= 9; i++){
              image[i] = new ImageIcon(ClassLoader.getSystemResource("outingassist/icons1/hotel"+(i+1)+".jpg"));
