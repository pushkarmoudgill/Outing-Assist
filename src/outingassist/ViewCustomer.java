...
public class ViewCustomer extends JFrame implements ActionListener{
    ...
    ViewCustomer(String username){
      ...
      /*  ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("outingassist/icons/viewall.jpg"));
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("outingassist/icons/viewall.jpg"));
